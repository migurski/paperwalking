...
<body>
    ...
    <p>
        ...
        <a href="http://en.wikipedia.org/wiki/Self-addressed_stamped_envelope"><b>self-addressed, stamped envelope</b></a>
        and we’ll mail you a printed copy of this map. If you don’t have a scanner,
