...
<p>
    OpenStreetMap - вики-карта всего мира, которую может редактировать каждый. "Обходной лист" - это способ обновить OSM c помощью бумажных распечаток, которые облегчат ввод изменений полученных непосредственно на местности, и предоставляют удобный способ обмена картами с подписями. 
</p>
<p>
