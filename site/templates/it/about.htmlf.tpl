...
<p>
    Una rete stradale approssimata degli Stati Uniti é stata praticamente completata in OSM ormai da un po' di tempo, dai tempi dell'importazione in blocco della base dati US Census TIGER/Line. Questo significa che i gruppi di mappatura degli U.S. possono essere leggermente controproducenti: l'idea del gruppo era stata pensata per posti dove più di tutto erano necessari i puri tracciati GPS, e dove spesso i partecipanti creano nuovi dati per una data località per la prima volta in assoluto. Ti presenti, ti viene fornito un dispositivo GPS portatile, vieni velocemente istruito nel suo utilizzo e mandato a piedi, in bicicletta o in auto a raccogliere i tracciati di strade e percorsi vicini. 
</p>
<p>
    Dato che attraverso le tasse noi contribuenti abbiamo finanziato la creazione di dati pubblici e liberi per ogni strada negli Stati Uniti, solitamente le semplici strade esistono già nel database. I dati TIGER possono essere poco accurati, ma con la condiscendente licenza delle immagini aeree di Yahoo é possibile correggere strade malposte senza dover lasciare la vostra scrivania: semplicemente basta usare l'editor integrato di OSM per spostare le strade fino a quando non corrispondono all'immagine satellitare di sfondo. Questo tipo di attività di "giardinaggio" può essere molto divertente ed avvicinarsi molto ad un <a href="http://it.wikipedia.org/wiki/Disturbo_ossessivo-compulsivo">DOC</a>, e personalmente abbiamo passato molte ore spostando nodi da una parte all'altra cercando di migliorare la grigla delle strade. 
</p>
<p>
    C'é un terzo modo di modificare una mappa ed é affrontato nel migliore dei modi utilizzando dei fogli ed é l'annotazione di caratteristiche locali, ad altezza uomo che sarebbero invisibili da un'immagine aerea, senza senso in assenza di dati stradali di base ed impossibili da raccogliere senza una visita di persona al sito: lampioni, negozi di biciclette, bagni pubblici, bancomat, scale, bar, pub, indirizzi ed altri frammenti del contesto geografico che fanno di OpenStreetMap un forte concorrente su scala umana di servizi più grandi e a pagamento.
</p>
