...
<p>
    "Обходной лист" (Walking Papers) - сервис, который воплощает идею использования бумажных карт ставшую реальностью после <a href="http://mike.teczno.com/notes/walking-papers.html"> первого эксперимента</a> в феврале. 
</p>
