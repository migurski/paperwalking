...
<p>
    OpenStreetMap kann auf Basis dieser eingescannten Karte mit dem web-basierten Editor
    <a href="http://wiki.openstreetmap.org/wiki/DE:Potlatch">Potlatch</a> hier auf dieser Seite bearbeitet werden.
</p>